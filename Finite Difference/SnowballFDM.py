...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 22 20:13:47 2023
...
class AutocallFDM(BasicFDM):
    ...
    def __init__(self, S0, barrier_ko, c, r, q, T, sigma, S_min, S_max, M, N, method):
...
class DNTFDM(BasicFDM):
    ...
    def __init__(self, S0, barrier_ko, barrier_ki, c, r, q, T, sigma, S_min, S_max, M, N, method):
        super().__init__(S0, r, q, T, sigma, S_max, S_min, M, N)
        self.c = c
...
class SnowballFDM(object):
    ...
    def get_snowball_fvalue(self):
        fdm1 = AutocallFDM(self.S0, self.barrier_ko, self.c, self.r, self.q, self.T, self.sigma, self.S_min, self.S_max, self.M, self.N, self.method)
        
        fdm2 = DNTFDM(self.S0, self.barrier_ko, self.barrier_ki, self.c, self.r, self.q, self.T, self.sigma, self.S_min, self.S_max, self.M, self.N, self.method)
        
        fdm3 = UOPFDM(self.S0, self.barrier_ko, self.c, self.r, self.q, self.T, self.sigma, self.S_min, self.S_max, self.M, self.N, self.method)
        
        fdm4 = DKOPFDM(self.S0, self.barrier_ko, self.barrier_ki, self.c, self.r, self.q, self.T, self.sigma, self.S_min, self.S_max, self.M, self.N, self.method)
    ...
    def get_snowball_f_mat(self, sigma=None, r=None):
        ...
        fdm1 = AutocallFDM(self.S0, self.barrier_ko, self.c, r, self.q, self.T, sigma, self.S_min, self.S_max, self.M, self.N, self.method)
        
        fdm2 = DNTFDM(self.S0, self.barrier_ko, self.barrier_ki, self.c, r, self.q, self.T, sigma, self.S_min, self.S_max, self.M, self.N, self.method)
        
        fdm3 = UOPFDM(self.S0, self.barrier_ko, self.c, r, self.q, self.T, sigma, self.S_min, self.S_max, self.M, self.N, self.method)
        
        fdm4 = DKOPFDM(self.S0, self.barrier_ko, self.barrier_ki, self.c, r, self.q, self.T, sigma, self.S_min, self.S_max, self.M, self.N, self.method)
